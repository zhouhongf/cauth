...
public class HttpUtil {
    ...
    public static String sendGetRequest(String reqURL, String param) {
        ...
        CloseableHttpClient newHttpclient = getHttpClient();
    ...
    public static String sendGetRequestWithHeaders(String reqURL, String param, Map<String, String> headers) {
        if (null != param) {
            reqURL += "?" + param;
            logger.info("HttpClient的请求地址是：" + reqURL);
        }
        CloseableHttpClient newHttpclient = getHttpClient();
